...
public class FolderMoldelSelectAdapter extends ArrayAdapter<FolderSelect> {
    List<FolderSelect> list;
    String selected;

    public FolderMoldelSelectAdapter(@NonNull Context context, int resource, @NonNull List<FolderSelect> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ((FolderSelect) getItem(position)).view = view;
        final FolderSelect item = (FolderSelect) getItem(position);
        ...
        view.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                for (FolderSelect model : FolderMoldelSelectAdapter.this.list) {
                    model.state = false;
